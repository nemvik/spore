...
export class ContactShadows {
 ...
 update(s:GameState){this.mesh.visible=s.stage===2;if(s.stage!==2)return;let count=0;
  ...
  add(s.player.pos.x,s.player.pos.z,s.player.genome.width*2.5,s.player.genome.length*4.2,s.player.heading);
