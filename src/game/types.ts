...
export interface GameState {
 maritime?: import('./maritime').Maritime; version: 3; military?: import('./military').Military; states?: import('./states').StateRegistry; cities?: import('./cities').CityRegistry; homePlanet?: import('./home-planet').HomePlanet; lineageHistory?: import('./lineage-history').LineageHistory; cellGrowth?: import('./cell-growth').CellGrowth; creatureStage?: CreatureStageState; tribe?: TribeState; machines?: MachineState; planet?: PlanetState; id: string; seed: number; stage: Stage; tick: number; rng: number; player: Player; worlds: [World|null,World|null,World|null]; world: World; campaign: Campaign; journey: Journey; lineage: LineageEntry[]; checkpoint: string|null; messages: {id:number; text:string; time:number}[]; deathReason: string|null; }
