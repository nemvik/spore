...
export const SITE_STORIES: readonly {
  ...
  { title: 'Zahrada a hladoví hosté',
    ...
    choices: ['U mateřské řasy stiskni T pro prozkoumání a znovu T pro odběr. Dones vzorek do kořenového kruhu za kameny a stiskni T. Úkol dokončí závojník, který se tam bezpečně nají.', 'Čelistí sniž přetíženou skupinu. Ponech alespoň jednoho původního konzumenta.'],
  ...
  { title: 'To, co nese proud',
    ...
    choices: ['U minerální kolonie stiskni T pro prozkoumání, pak T pro odběr. Bez sprintu dones vzorek do kruhu mezi kameny a T jej zasaď.', 'Delší dosah odebere vzorek z okraje. Štíhlé tělo a zadní bičík snáz drží směr.'],
  ...
  { title: 'Světlo pro potomka',
    ...
    choices: ['Nejdřív dokonči zahradu a vír. Pak u jižního porostu odeber kulturu pomocí T a zasaď ji pomocí T v kruhu u severního odtoku. Zelená stopa ji živí, modrá usnadní cestu.', 'Použij smysly, kryt a nabídnutou potravu. Výpad lovce se nedokáže otočit za úhybem.'],
...
export const JOURNEY_COPY = {
  ...
  firstFeast: 'Porost je zasazený. Teď nech místního býložravce dojít k nové potravě a najíst se. Pokud ho plaší lovec, odlákej lovce potravou stranou.',
