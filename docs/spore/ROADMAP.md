...
| [SP-009 · Města a civilizace](#sp-009) | B | K plánu | SP-008, SP-010.A; globální integrace s B/C | [Místní adresa A](SP-010A-CONTRACT.md), [geografický kontext B](SP-010B-CONTRACT.md) a [výběr adres C](SP-010C-CONTRACT.md); navazuje A — založení a persistence skutečných měst |
| [SP-010 · Celá planeta](#sp-010) | B | Rozpracováno | SP-001 | **A hotovo:** [identita domova a lokalit](SP-010A-REPORT.md), [smlouva pro města](SP-010A-CONTRACT.md), [plán A](../superpowers/plans/2026-09-24-sp-010a-home-planet.md); **B hotovo:** [geografie a ověření](SP-010B-REPORT.md), [smlouva B](SP-010B-CONTRACT.md); **C navigace/návraty hotové:** [report C](SP-010C-REPORT.md), [smlouva C](SP-010C-CONTRACT.md); integrace skutečných měst otevřená do SP-009 |
...
- [ ] Kamera přechází od místního dění ke globálnímu přehledu s čitelnou navigací a výběrem měst. **C dodává atlasovou kameru, výběr lokalit a konkrétní adresní API. Výběr skutečných měst zůstává otevřený do SP-009; produkce nevytváří demonstrační města.**
...
| SP-010.C — globální navigace a města | Rozpracováno — navigace hotová | [Plán](../superpowers/plans/2026-09-24-sp-010c-navigation.md), [kontrakt](SP-010C-CONTRACT.md), [report](SP-010C-REPORT.md). Doložené výpravy, návraty, migrace a výkon; skutečná města/výběr čekají na SP-009.A. |

A/B zachovávají dosavadní světy; C přidává skutečně hrané pevninské výpravy do detailů vytvořených až při návštěvě. Výprava pozastaví původní svět a vrátí jej beze změny. Nejde o souvislý globální terén, námořní expanzi ani městskou ekonomiku. Výběr skutečných měst zůstává otevřený, přesné rozhraní dodává [smlouva C](SP-010C-CONTRACT.md). `GameState.planet` nadále označuje lokální terraformaci pobřeží. SP-009.A má navázat založením a persistencí měst podle adresního kontraktu; ekonomiku/strategie řeší SP-009 a jejich následky SP-007.B2, vesmírnou filozofii SP-007.D. Celé SP-010, SP-009 a SP-007.B2/D se tím neuzavírají.
