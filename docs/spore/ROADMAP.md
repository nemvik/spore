...
| [SP-008 · Aktivní kmenová společnost](#sp-008) | B | Rozpracováno | SP-003, SP-007.A (smlouva dědictví) | **A/B/C/D hotovo:** [aktivní sousedé](SP-008A-REPORT.md), [kulturní výstroj](SP-008B-REPORT.md), [hudební setkání](SP-008C-REPORT.md), [domestikace](SP-008D-REPORT.md); E/F otevřené |
...
- [ ] **SP-008.E:** viditelný náčelník má vlastní použitelnou roli v hraní; zbývající část původního společného kritéria výstroje/domestikace/náčelníka.
...
A/B/C/D zachovávají tělo, jídelníček, pracovní nástroje, boj a jednorázové výsledky. C přidává aktivní hudební požadavky a nástroje vedle oddělené kulturní výstroje; chochol a dědictví se uplatní jednou na skutečně odpovídající hráče. D odlišuje původní zvíře od člena vlastního druhu a symbionta; pracuje se skutečnou faunou, zdroji, kontaktem a zásobami. Neuzavírají celou SP-008 ani SP-007. **Nové následky kmene pro civilizaci patří výhradně do SP-007.B1**; A/B/C/D nemění strojový archetyp podle nových výsledků. B přebírá z SP-005 jen potřebnou identitu/revize, oddělený návrh a přenos; příslušná čitelnost, geometrie a odezva SP-017 jsou součástí B/C/D. Připravené browser vstupy, odehrané akce a meze automatického zvukového ověření jsou oddělené v reportech.
