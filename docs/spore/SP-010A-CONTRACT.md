...
SP-010.B vytvoří kontinenty/oceány, terén a explicitní zasazení habitatů. SP-010.C doplní globální kameru, navigaci, návraty a výběr měst. SP-009.A použije tuto adresu při založení a ukládání měst; ekonomika a nezávislé strategie zůstávají SP-009. SP-007.B2 následně spotřebuje skutečné civilizační volby, SP-007.D vesmírné výsledky. Tento kontrakt nezavádí cestování ani nové navštívené světy.
